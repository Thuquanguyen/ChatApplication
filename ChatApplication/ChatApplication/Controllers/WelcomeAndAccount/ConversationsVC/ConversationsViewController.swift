...
class ConversationsViewController: UIViewController {
    ...
    @IBOutlet weak var labelNone: UILabel!
    ...
    override func viewDidLoad() {
        ...
        if let email = UserDefaults.standard.value(forKey: "email") as? String{
            ...
            if safeEmail == "adminkuchat-gmail-com"{
                ...
                naviBar.rightButtonFirst.setImage(UIImage("icon_add"), for: .normal)
                naviBar.rightButtonFirst.sizeIcon = CGFloat(20)
            }
        }
...
extension ConversationsViewController{
    ...
    private func setupTableView() {
        ...
        tableView.registerNibCellFor(type: ConversationTableCell.self)
    }
        ...
        DatabaseManager.shared.getAllConversations(for: safeEmail, completion: { [weak self] result in
            ...
            case .success(let conversations):
                ...
                guard !conversations.isEmpty else {
                    ...
                    self?.labelNone.isHidden = false
                    return
                }
                self?.labelNone.isHidden = true
...
extension ConversationsViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueCell(with: ConversationTableCell.self, for: indexPath)
